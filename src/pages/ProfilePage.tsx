          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-150 dark:border-slate-700 shadow-sm overflow-hidden p-6 relative">
            ...
            {isOwnProfile && !isEditing && (
              <button
                ...
                className="absolute top-6 right-6 flex items-center gap-1.5 px-3 py-1.5 rounded-lg border text-xs font-semibold hover:bg-gray-50 border-gray-200 text-gray-600 dark:border-slate-700 dark:hover:bg-slate-700 dark:text-slate-200 cursor-pointer transition-all"
